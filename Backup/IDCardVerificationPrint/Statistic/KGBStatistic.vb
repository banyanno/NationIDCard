...
Public Class KGBStatistic
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IDCardVerificationPrint.KGBStatistic.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedKGBStatistic
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As KGBStatistic = New KGBStatistic
        rpt.Site = Me.Site
        Return rpt
    End Function
