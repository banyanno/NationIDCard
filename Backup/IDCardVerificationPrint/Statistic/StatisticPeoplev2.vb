...
Public Class StatisticPeoplev2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IDCardVerificationPrint.StatisticPeoplev2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatisticPeoplev2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatisticPeoplev2 = New StatisticPeoplev2
        rpt.Site = Me.Site
        Return rpt
    End Function
