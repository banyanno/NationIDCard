...
Public Class StatisticPeopleV1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IDCardVerificationPrint.StatisticPeopleV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatisticPeopleV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatisticPeopleV1 = New StatisticPeopleV1
        rpt.Site = Me.Site
        Return rpt
    End Function
