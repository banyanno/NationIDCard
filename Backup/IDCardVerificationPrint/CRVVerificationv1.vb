...
Public Class CRVVerificationv1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IDCardVerificationPrint.CRVVerificationv1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NotCorrect() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRVVerificationv1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVVerificationv1 = New CRVVerificationv1
        rpt.Site = Me.Site
        Return rpt
    End Function
