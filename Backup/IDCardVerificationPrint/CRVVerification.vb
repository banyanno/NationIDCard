...
Public Class CRVVerification
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IDCardVerificationPrint.CRVVerification.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVVerification
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVVerification = New CRVVerification
        rpt.Site = Me.Site
        Return rpt
    End Function
