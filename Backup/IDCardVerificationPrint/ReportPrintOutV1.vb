...
Public Class ReportPrintOutV1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IDCardVerificationPrint.ReportPrintOutV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportPrintOutV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportPrintOutV1 = New ReportPrintOutV1
        rpt.Site = Me.Site
        Return rpt
    End Function
